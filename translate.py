...
Commands:
    translate.py translate --from LANG --to LANG --text "hello"
...
def translate_text(text, from_lang="auto", to_lang="en"):
    ...
    url = f"https://translate.google.com/translate_a/single?{urllib.parse.urlencode(params)}"
...
def main():
    ...
    if args.command == "translate":
        result = translate_text(args.text, args.from_lang, args.to_lang)
